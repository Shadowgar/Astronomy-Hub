...
| BLK-003 | module2-stars-full | G1 / G5 | Stellarium Web Engine **`src`**.c sources were not discoverable via workspace search when local external trees were gitignored; line-reference for `hip.c` / `stars.c` / `bv_to_rgb.c` needed a pinned Git URL + paths. | Document upstream repo + pinned commit + `src/` paths (see **`stellarium-web-engine-src.md`**). | Sky Engine Port | 2026-04-18 | **`BLK-003` RESOLVED**: **`docs/runtime/port/stellarium-web-engine-src.md`** + **EV-0037** (GitHub `Stellarium/stellarium-web-engine` at commit **`63fb3279e85782158a6df63649f1c8a1837b7846`**). | RESOLVED |
