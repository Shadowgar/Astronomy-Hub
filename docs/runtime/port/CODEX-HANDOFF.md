...
**Last updated:** 2026-04-21, evidence **EV-0076** (module 2 G4 deterministic replay extension for traversal/lookup/catalog-astrometry slices in `computeModule2PortFingerprint`; module 2 bundle 39/39 / 11 files; typecheck + build + module 0/1/2 bundles PASS).
...
5. **`docs/runtime/port/evidence-index.md`** — the evidence ledger. Cite an existing `EV-xxxx` when referencing work; add a new row for any new work you land (**next free ID: EV-0077**; `EV-0067` and `EV-0068` are intentionally unused).
...
| `module2-stars-full` | **BLOCKED / partial** (active) | `npm run test:module2` → **39/39 / 11 files** | G0/G1 PASS (EV-0036). G2/G3/G4 partial (EV-0038–EV-0076). G5–G7 FAIL. See `module2-source-contract.md` §5 + §7. |
...
npm run test:module2     # 39/39 across 11 files (module 2 gate bundle as of EV-0076)
