...
**Last updated:** 2026-04-21, evidence **EV-0083** (`stars_list` adapter runs in `buildSkyDiagnostics` / scene `starsListVisitCount`; module 2 bundle 47/47 / 12 files; typecheck + build + module 1/2 bundles PASS).
...
5. **`docs/runtime/port/evidence-index.md`** — the evidence ledger. Cite an existing `EV-xxxx` when referencing work; add a new row for any new work you land (**next free ID: EV-0084**; `EV-0067` and `EV-0068` are intentionally unused).
...
| `module2-stars-full` | **BLOCKED / partial** (active) | `npm run test:module2` → **47/47 / 12 files** | G0/G1 PASS (EV-0036). G2/G3/G4 partial (EV-0038–EV-0083). G5–G7 FAIL. See `module2-source-contract.md` §5 + §7. |
