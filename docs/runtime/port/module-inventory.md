...
- **`eraApcs` / `eraApco`:** **`eraApcs`** **PORTED** (`erfaApcs.ts`, **EV-0015**); **`eraApco`** **PORTED** (`erfaApco.ts`, SOFA vector test, **EV-0016**). Hub **`astrom`** wiring — `docs/runtime/port/module0-eraApco-port-plan.md` §4.
