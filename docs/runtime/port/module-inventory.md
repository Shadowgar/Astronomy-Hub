...
- **`eraApcs` / `eraApco`:** **`eraApcs`** **PORTED** (`erfaApcs.ts`, `test_erfa_apcs.test.js`); **`eraApco`** call graph and Hub `astrom` seam — `docs/runtime/port/module0-eraApco-port-plan.md`, evidence **EV-0015**.
