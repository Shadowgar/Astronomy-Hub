export const STARS_C_CENTER_REPROJECT_THRESHOLD_RAD = 0.0035
export const STARS_C_FOV_REPROJECT_THRESHOLD_DEG = 0.35
export const STARS_C_LIMIT_MAG_REPROJECT_THRESHOLD = 0.02
export const STARS_C_SCENE_TIMESTAMP_REPROJECT_THRESHOLD_MS = 250
export const STARS_C_MAX_PROJECTION_REUSE_STREAK = 6
