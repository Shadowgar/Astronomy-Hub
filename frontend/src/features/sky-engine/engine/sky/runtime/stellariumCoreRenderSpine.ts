...
/**
 * Stellarium `core_render` preamble (`core.c`), control order only:
 ...
 * 4. `labels_reset` — clear per-frame label accumulation
 *
 * Full painter / label pipeline is not implemented here; this preserves call order for downstream work.
 */
