 ...
 */
export function deriveObserverGeometry(observer: SkyEngineObserver, sceneTimestampIso: string) {
  return {
    ...
    localSiderealTimeDeg: computeLocalSiderealTimeDeg(observer.longitude, sceneTimestampIso),
  }
}
