...
export function deriveSunVisualCalibration(altitudeDeg: number): SkyEngineVisualCalibration {
  ...
  if (phaseLabel === 'Daylight') {
    ...
    return {
      ...
      starVisibility: interpolate(0.22, 0.46, amount),
      starFieldBrightness: interpolate(0.22, 0.42, amount),
      starLabelVisibility: interpolate(0.22, 0.36, amount),
      starHaloVisibility: interpolate(0.08, 0.05, amount),
