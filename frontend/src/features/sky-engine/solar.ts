...
export function deriveSunVisualCalibration(altitudeDeg: number): SkyEngineVisualCalibration {
  ...
  if (phaseLabel === 'Daylight') {
    ...
    return {
      ...
      horizonGlowAlpha: interpolate(0.22, 0.14, amount),
      landscapeFogColorHex: interpolateHex('#748498', '#b7d1ec', amount),
      groundTintHex: interpolateHex('#5d6048', '#7b6e4f', amount),
      landscapeShadowAlpha: interpolate(0.3, 0.12, amount),
      starVisibility: interpolate(0.14, 0.05, amount),
      starFieldBrightness: interpolate(0.13, 0.05, amount),
      starLabelVisibility: interpolate(0.18, 0.08, amount),
      starHaloVisibility: interpolate(0.07, 0.03, amount),
      starTwinkleAmplitude: interpolate(0.008, 0.003, amount),
      atmosphereExposure: interpolate(0.92, 1.1, amount),
  ...
  if (phaseLabel === 'Low Sun') {
    ...
    return {
      ...
      horizonGlowAlpha: interpolate(0.38, 0.22, amount),
      landscapeFogColorHex: interpolateHex('#514c56', '#8c7562', amount),
      groundTintHex: interpolateHex('#404338', '#5c5d44', amount),
      landscapeShadowAlpha: interpolate(0.44, 0.24, amount),
      starVisibility: interpolate(0.48, 0.22, amount),
      starFieldBrightness: interpolate(0.44, 0.22, amount),
      starLabelVisibility: interpolate(0.46, 0.22, amount),
      starHaloVisibility: interpolate(0.16, 0.08, amount),
      starTwinkleAmplitude: interpolate(0.012, 0.006, amount),
      atmosphereExposure: interpolate(0.78, 0.96, amount),
  ...
  return {
    ...
    horizonGlowAlpha: interpolate(0.12, 0.2, amount),
    landscapeFogColorHex: interpolateHex('#0d1623', '#1d2f42', amount),
    groundTintHex: interpolateHex('#21342f', '#304338', amount),
    landscapeShadowAlpha: interpolate(0.48, 0.36, amount),
    starVisibility: interpolate(1, 0.7, amount),
    starFieldBrightness: interpolate(0.92, 0.68, amount),
    starLabelVisibility: interpolate(0.84, 0.58, amount),
    starHaloVisibility: interpolate(0.16, 0.08, amount),
    starTwinkleAmplitude: interpolate(0.014, 0.008, amount),
    atmosphereExposure: interpolate(0.7, 0.8, amount),
