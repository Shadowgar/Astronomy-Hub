...
export const WEBGL2_STARS_INTERACTION_TRACE_QUERY_PARAM = 'webgl2StarsInteractionTrace'
export const WEBGL2_STARS_COALESCE_POINTER_MOVE_QUERY_PARAM = 'webgl2StarsCoalescePointerMove'
export const WEBGL2_STARS_COALESCE_WHEEL_QUERY_PARAM = 'webgl2StarsCoalesceWheel'
export const WEBGL2_STARS_DRAW_QUERY_PARAM = 'webgl2StarsDraw'
...
export interface WebGL2StarsPerfTraceConfig {
  ...
  readonly interactionTraceEnabled: boolean
  readonly coalescePointerMoveEnabled: boolean
  readonly coalesceWheelEnabled: boolean
...
export function resolveWebGL2StarsPerfTraceConfig(input: {
  ...
  return {
    ...
    interactionTraceEnabled: debugAllowed && params.get(WEBGL2_STARS_INTERACTION_TRACE_QUERY_PARAM) === '1',
    coalescePointerMoveEnabled: debugAllowed && params.get(WEBGL2_STARS_COALESCE_POINTER_MOVE_QUERY_PARAM) === '1',
    coalesceWheelEnabled: debugAllowed && params.get(WEBGL2_STARS_COALESCE_WHEEL_QUERY_PARAM) === '1',
    drawEnabled: debugAllowed ? resolveOptOutFlag(params.get(WEBGL2_STARS_DRAW_QUERY_PARAM)) : true,
    devOnly,
  }
}