  ...
  data (context) {
    return {
      menuItems: [
        ...
        { title: this.$t('Dense Stars: Visual Sky'), icon: 'mdi-eye-outline', profile: 'visual-default' },
        { title: this.$t('Dense Stars: Binocular Depth'), icon: 'mdi-binoculars', profile: 'binocular' },
